...
async function acceptRequest(id) {
    await fetch(`https://yallafix1.onrender.com/api/service-requests/${id}/accept`, { method: 'POST' });
    loadServiceRequests();
}

// Function to reject a request
async function rejectRequest(id) {
    await fetch(`https://yallafix1.onrender.com/api/service-requests/${id}/reject`, { method: 'POST' });
    loadServiceRequests();
}
